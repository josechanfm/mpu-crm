<template>
    <MasterLayout title="Dashboard">
        ...
        <a-button @click="createRecord">Create Article</a-button>
        <div class="container mx-auto pt-5">
            <div class="bg-white relative shadow rounded-lg overflow-x-auto">
                <a-table :dataSource="articles" :columns="columns" :row-key="record => record.root_id">
...
export default {
    ...
    props: ['article_categories','departments','articles'],
    data() {
        return {
            modal:{
                isOpen:false,
