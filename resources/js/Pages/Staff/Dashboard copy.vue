      ...
      <div
        ...
        <div class="h-96 col-span-4 bg-gradient-to-tr from-green-800 to-green-500 rounded-md flex items-center">
          <div class="ml-20 w-80">
            ...
            <p class="text-indigo-100 mt-4 capitalize font-thin tracking-wider leading-7">This page is for general MPU
              staff who DO NOT belongs to any administration department or faculty.</p>
