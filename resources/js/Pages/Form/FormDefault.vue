                ...
                >
                    <template v-for="field in form.fields">
                        <div v-if="form.require_member" :key="field.id">
                            <a-form-item label="Member Id" :name="field.id" :rules="[{required:field.required, 'message':'必填欄位/Is Required'}]">
                                <a-input type="inpuut" v-model:value="$page.props.user.id" />
                            </a-form-item>                        
                        </div>
                        <div v-if="field.type=='input'" :key="field.id">
                            <a-form-item :label="field.field_label" :name="field.id" :rules="[{required:field.required, 'message':'必填欄位/Is Required'}]">
                        ...
                        <div v-else-if="field.type=='email'" :key="field.id">
                            <a-form-item :label="field.field_label" :name="field.id" :rules="[{required:field.required, 'message':'必填欄位/Is Required'},{type:'email'}]" >
                                <a-input type="input" v-model:value="formData[field.id]" />
                            </a-form-item>                        
                        </div>
                        <div v-else-if="field.type=='true_false'" :key="field.id">
                            <a-form-item :label="field.field_label" :name="field.id" :rules="[{required:field.required, 'message':'必填欄位/Is Required'},{type:'boolean'}]" >
