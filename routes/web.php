...
Route::prefix('souvenir')->group(function(){
    ...
    Route::any('/verify-email',[App\Http\Controllers\Souvenir\LoginController::class,'verifyEmail'])->name('souvenir.verifyEmail');
    Route::any('/verify-netid', [App\Http\Controllers\Souvenir\LoginController::class, 'verifyNetid'])->name('souvenir.verifyNetid');

    Route::any('/send_reset_password_to_mail',[App\Http\Controllers\Souvenir\LoginController::class,'sendResetPasswordToEmail'])->name('souvenir.sendResetPasswordToEmail');
    ...
    Route::get('{id}/receipt',[App\Http\Controllers\Souvenir\OrderController::class,'receipt'])->name('souvenir.order.receipt');
...
Route::get('s/{token}',[\App\Http\Controllers\ShortenerController::class,'index']);
